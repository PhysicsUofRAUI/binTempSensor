...
DHT_Unified dht11(DHTPIN11, DHTTYPE);
DHT_Unified dht12(DHTPIN12, DHTTYPE);
...
// bin four
BinSensor bin_sensor10((float)0.5);
BinSensor bin_sensor11((float)0.5);
BinSensor bin_sensor12((float)0.5);
...
void loop() {
  ...
  /*
   * Check the sensors in the fourth bin
   */
   result = bin_sensor10.check_sensor(dht10);
  ...
  {
    sms.beginSMS("your-phone-number");
    sms.print("Top of bin four has increased by ");
    sms.print(result);
    sms.endSMS();
  }

  result = bin_sensor11.check_sensor(dht11);
  ...
  {
    sms.beginSMS("your-phone-number");
    sms.print("Middle of bin four has increased by ");
    sms.print(result);
    sms.endSMS();
  }

  result = bin_sensor12.check_sensor(dht12);
  ...
  {
    sms.beginSMS("your-phone-number");
    sms.print("Bottom of bin four has increased by ");
    sms.print(result);
    sms.endSMS();
  }
