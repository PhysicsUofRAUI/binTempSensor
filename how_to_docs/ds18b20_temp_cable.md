...
## 2.3 Parts
If you bought a kit then you will have all the DS18B20 sensors you need but the wire will not be supplied and I encourage you to go to you local hardware store to get it but I have included a link to Home Depot to show you which type I used (except I used 4 wire).
